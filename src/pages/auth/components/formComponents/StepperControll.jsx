...
const StepperControll = ({handleClick, currentStep, steps}) => {
  return (
    <div className='container flex justify-around mt-4 mb-8'>
        ...
        border-2 border-slate-300 hover:bg-slate-700 hover:text-white transition duration-200
        ...
        ease-in-out'>
            {currentStep === steps.length - 1 ? 'Salvar' : 'Continuar'}
        </button>
    </div>
  )
}
