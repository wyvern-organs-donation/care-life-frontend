        ...
        <main className="admin-main">
          ...
          <div className="cards-row">
            <WhiteCard
              ...
              imgSrc="/src/assets/admin/Group.svg"
              count={users.length}
            />
            <WhiteCard
              title="Órgãos Cadastrados"
              imgSrc="/src/assets/admin/heart.svg"
              count={organs.length}
            />
            <WhiteCard
              title="Receptores Cadastrados"
              imgSrc="/src/assets/admin/registered-receivers.svg"
              count={receptor.length}
            />
          </div>
        </main>
      </div>
